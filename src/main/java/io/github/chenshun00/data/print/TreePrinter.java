package io.github.chenshun00.data.print;
...
public class TreePrinter {
    ...
    private static <T extends Comparable<?>> int maxLevel(Node node) {
        ...
        return Math.max(TreePrinter.maxLevel(node.leftChild), TreePrinter.maxLevel(node.rightChild)) + 1;
    }
